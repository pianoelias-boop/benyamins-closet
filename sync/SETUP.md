...
1. Go to https://sheets.new and create a blank spreadsheet. Name it after the closet, e.g. "Benyamin's Closet notebook".
...
4. Paste that URL into `config.js` as the value of `"syncUrl"`, commit and push.
   (Or hand the URL to Claude and it will do this step.) The `"notebookKey"` next to it names his list
