...
3. the **hard rules from the owner** in step 3 (Benyamin's: wide legs only, relaxed or boxy tops only, no Universal Works tops, menswear only; rounds publish without review).
...
3. Read build/suggest/profile.md in full (the automatic section from his notebook plus the owner's hand-written notes) and build/suggest/pending/shortlist.md. Choose exactly 8 shortlist entries. Hard rules from the owner: menswear only, never a piece listed as women's; trousers, jeans and shorts must be wide-leg (wide, big, baggy, balloon, pleated-wide or palazzo), never slim, skinny, tapered or plain straight; shirts, knitwear, sweatshirts and jackets must be described as relaxed, boxy, oversized, loose or generous through the chest (he needs 25 inches flat across the chest), never slim or fitted; never a top from Universal Works, whose tops do not fit him (their trousers are fine). Your picks publish to the site automatically without his review, so when in doubt leave a piece out. Then: at most 2 per brand and never two from the same brand in the same category; at most 1 jacket or coat; include at least 1 pair of trousers or jeans and at least 1 shirt or piece of knitwear when the shortlist offers them; at most 1 entry marked "ANOTHER COLOUR of a piece already in the closet" (a new colour of something he has is welcome, but only one per week); avoid anything the profile says to steer away from; prefer his fabrics (herringbone, seersucker, corduroy, linen, Japanese denim, textured knits), his cuts (wide, pleated, high-rise, boxy) and his colours (olive and green first, then brown, ecru, indigo and midnight teal); prefer pieces that would work for dancing or a work trip as the profile describes; avoid near-duplicates of each other; prefer pieces whose descriptions are specific since you cannot see photos.
